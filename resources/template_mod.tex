...
\newcommand{\myname}{studentName}
\newcommand{\myandrew}{andrewID@andrew.cmu.edu}
\newcommand{\mysection}{Section labSection}
\newcommand{\myhwnum}{homeworkNumber}

% Some useful commands
\newcommand{\tab}{\hspace*{6.35mm}} % original was 2em
\newcommand{\nat}{\mathbb{N}}
\newcommand{\lp}{\left(}
\newcommand{\rp}{\right)}
\newcommand{\code}[1] {\texttt{#1}}
\newcommand{\work}[2] {W_{\texttt{#1}} \lp #2 \rp}
\newcommand{\funspan}[2] {S_{\texttt{#1}} \lp #2 \rp} % \span is already taken
